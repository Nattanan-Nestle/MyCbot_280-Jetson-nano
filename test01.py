...
# ------------------------------------------------------------------
SCALE = 0.28           # mm/pixel (จาก calibration scale)
...
def main():
    ...
    print("เคลื่อนที่ไปยังตำแหน่งเหนือวัตถุ (ความสูงปลอดภัย)...")
    mc.send_coords([target_x, target_y, 120.0, FIXED_RX, FIXED_RY, FIXED_RZ], SPEED)
    ...
    cv2.putText(frame, f"{color_name} {shape}", (cX+10, cY-10),
