...
print("ลด Z ลง...")
mc.sync_send_coords([257.6, -60.4, 300.0, 177.34, 0.0, -45.28], SPEED)
# ลด Z ลงอีก (ส่งพิกัดที่สอง แล้วรอให้เสร็จ)
mc.sync_send_coords([257.6, -60.4, 100.0, 177.34, 0.0, -45.28], SPEED)
print("ถึงตำแหน่งวางแล้ว")
# ปล่อย gripper
print("สั่ง gripper กางออก...")
mc.set_gripper_state(0, 100)
mc.sync_send_coords([257.6, -60.4, 500.0, 177.34, 0.0, -45.28], SPEED)
